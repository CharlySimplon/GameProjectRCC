...
def summon_monster(hp_player, potion, floor,difficulty, attack_player,score):
    ...
    hp_player, score, attack_player, potion, floor = battle(hp_player,hp_ennemy,potion,droprate, force_ennemy,score,score_ennemy,difficulty,floor,attack_player)
